...
void widgetKeyBoard::createKeyboard()
{
    ...
    if (this->isNumericPad() == true)
    {
        ...
        */
        ...
        //tmpLayout->addWidget(createNewKey(tr(QString::fromLocal8Bit("�").toUtf8()))); // Ö
        //tmpLayout->addWidget(createNewKey(tr(QString::fromLocal8Bit("�").toUtf8()))); // Ä
        //tmpLayout->addWidget(createNewKey(tr(QString::fromLocal8Bit("�").toUtf8()))); // Ü
        tmpLayout->addWidget(createNewKey(tr("@")));
